...
- **Repository:** https://github.com/harshalpardeshi93-lgtm/mlops-iris-classifier
- **Primary language:** Python
- **Maintainer:** Harshal Pardeshi
...
Git provides version control and branching for ML project code.
Large datasets and generated model files should not be committed directly to Git.
...
Conflict markers must be removed before completing the merge.
Testing the project after resolving a conflict helps verify that the merged code still works.
